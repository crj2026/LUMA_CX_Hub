// Falls back to this if the GORGIAS_DOMAIN env var isn't set. Replace the
// subdomain with the brand's: [GORGIAS_SUBDOMAIN].gorgias.com
const DEFAULT_DOMAIN = "[GORGIAS_SUBDOMAIN].gorgias.com";
