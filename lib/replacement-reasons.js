// Replacement reasons taxonomy — [BRAND_NAME].
//
// Two-tier structure (Main Reason → Sub Reason), both multi-select.
// This taxonomy is mostly brand-agnostic — covers the common fulfilment
// and product issues for subscription and one-time orders. Adjust the
// sub-reason lists to match the brand's products where needed.
